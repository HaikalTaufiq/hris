                  ...
                  return LemburCard(
                    ...
                    onApprove: () async {
                      ...
                      if (message != null) {
                        ...
                        NotificationHelper.showSnackBar(context, 'Gagal menyetujui lembur', isSuccess: false);
                      }
                    },
                    onDecline: () async {
                      ...
                      if (message != null) {
                        ...
                        NotificationHelper.showSnackBar(context, 'Gagal menolak lembur', isSuccess: false);
                      }
                    },
                  );
                },
